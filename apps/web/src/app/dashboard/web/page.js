...
export default function WebChannelDashboardPage() {
    ...
    <div style={{ minHeight: '100vh', backgroundColor: '#f5f5f5' }}>
      <header style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
          <h1 style={{ margin: 0, color: '#111827', fontSize: '1.3rem' }}>Web Chats</h1>
      ...
      <main style={{ padding: '2rem 2rem 3rem' }}>
        <div style={{
          ...
          <p style={{ margin: 0, marginBottom: '0.75rem', fontSize: '0.95rem', color: '#4b5563' }}>
            This channel will let you manage conversations from your website widgets and in-app chat.
          </p>
          <div style={{
            display: 'inline-flex',
            alignItems: 'center',
          ...
          <p style={{ margin: 0, fontSize: '0.9rem', color: '#6b7280' }}>
            You&rsquo;ll see live web sessions, active visitors, and unified conversations here once the channel is enabled.
          </p>
        </div>
      </main>
    </div>
