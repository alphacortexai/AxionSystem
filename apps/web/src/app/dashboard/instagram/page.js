...
export default function InstagramChannelDashboardPage() {
    ...
    <div style={{ minHeight: '100vh', backgroundColor: '#f5f5f5' }}>
      <header style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
          <h1 style={{ margin: 0, color: '#111827', fontSize: '1.3rem' }}>Instagram</h1>
      ...
      <main style={{ padding: '2rem 2rem 3rem' }}>
        <div style={{
          ...
          <p style={{ margin: 0, marginBottom: '0.75rem', fontSize: '0.95rem', color: '#4b5563' }}>
            Manage Instagram DMs, replies, and mentions from a single place.
          </p>
          <div style={{
            display: 'inline-flex',
            alignItems: 'center',
          ...
          <p style={{ margin: 0, fontSize: '0.9rem', color: '#6b7280' }}>
            Once enabled, you&rsquo;ll be able to connect your Instagram Business accounts and see unified conversations here.
          </p>
        </div>
      </main>
    </div>
